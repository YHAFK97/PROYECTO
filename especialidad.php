                    ...
                    <div class="row"> 
                        ...
                        <div class="col-md-3">
                            <h1>INGRESAR DATOS</h1>
                                <form action="Aespecialidad.php" method="POST">              
                                ...
                                <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <th><a href="Eespecialidad.php?id_especialidad=<?php echo $row['id_especialidad'] ?>" class="btn btn-info">Editar</a></th>
                                                <th><a href="Bespecialidad.php?id_especialidad=<?php echo $row['id_especialidad'] ?>" class="btn btn-danger">Eliminar</a></th>                                        
                                            </tr>
                                        <?php 
                                            }
                                        ?>
